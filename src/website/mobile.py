...
class DetectMobileBrowserMiddleware(object):
    def process_request(self, request):#, view, slug, *args, **kwargs):
        ...
        if request.META.has_key('HTTP_USER_AGENT'):
            ...
            print user_agent
            #if b or v:
            #    return HttpResponseRedirect(reverse(view, args=(slug, )) if slug else reverse(view))
            #return super(DetectMobileBrowserMiddleware, self).get(request, *args, **kwargs)
